...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://mdisk.me/convertor/9x16/iikzIM')
        ]
    )
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/movie_a1"),
                InlineKeyboardButton("Series ⭕️", url="https://t.me/movie_a1")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/ggggaav'),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ CHANNEL', url='https://t.me/ggggaav'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Movie", url="https://t.me/movie_a1"),
        InlineKeyboardButton("Series ⭕️", url="https://t.me/movi_a1")
    ])
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/movie_on1")
    ])
